...
@WebMvcTest(controllers = HelloController.class, secure = false) //web집중하는 어노테이션 (컨트롤러만사용가능) @Contorller, @ControllerAdvice
public class HelloControllerTest {
    ...
    public void helloDto_Test() throws Exception{
        ...
        mvc.perform(
                get("/hello/dto")
                        .param("name", name) //요청 파라미터 설정(스트링값만 허용, 숫자,날짜도 문자로변환)
